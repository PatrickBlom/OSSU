...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname cond-expressions-pt1) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;; () balance each other
;; [] balance each otehr
;; in racket they are treated the same.
